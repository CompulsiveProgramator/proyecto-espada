 ...
 */
Color::Color (const Color &p ): color {p.color[R], p.color[G]
                                                  , p.color[B], p.color[A] }
{}
 ...
 */
double &Color::operator[] (const unsigned char idx )
{  return color[idx];
}
 ...
 */
double Color::operator[] (const unsigned char idx ) const
{  return color[idx];
}
 ...
 *       bloque
 */
float *Color::cloneToFloatArray () const
